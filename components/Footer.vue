    ...
    <div class="m-0">
      <div class="bottom p-10">
        <p class="text-purple-50">
          Copyright &copy; rellyepikprograma 2022. All Rights Reserved unless noted.
          <br />
          <br />
          <div class="md:flex-auto md:flex-row-reverse mt-2 flex-row flex icons align-right">
            <a href="https://github.com/rellyepikprograma">
            <svg
              height="30"
              viewBox="0 0 16 16"
              version="1.1"
          ...
          <a href="https://scratch.mit.edu/users/rellyepikprograma">
            <svg
              version="1.1"
              ...
              width="30"
              height="30"
              viewBox="0,0,54.81885,81.9421"
            >
              <g transform="translate(-213,-139.9999)">
                <g
